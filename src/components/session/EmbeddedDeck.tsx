...
// Stays dark (navy/emerald) — it's a screen/presentation surface, not paper
// SECURITY: Only accepts same-domain relative paths starting with "/"
// =============================================================================
...
export default function EmbeddedDeck({ src, title }: Props) {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full rounded-xl border border-[#18242B]/15 overflow-hidden shadow-sm"
    >
      {/* Toolbar — navy chrome */}
      <div className="flex items-center justify-between px-4 py-3 bg-[#08212C] border-b border-white/8">
        ...
        {safeSrc && (
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium text-white/50 hover:text-white hover:bg-white/8 transition-all duration-200"
          >
      ...
      <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
        {safeSrc && !hasError ? (
          ...
          /* Placeholder / error state — deep emerald surface */
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-[#0E3B35]">
