...
export default function EmbeddedDeck({ src, title }: Props) {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full rounded-xl border border-white/10 bg-[#060F1A] overflow-hidden"
    >
      {/* Toolbar */}
      <div className="flex items-center justify-between px-4 py-2.5 bg-[#0D2137] border-b border-white/10">
      ...
      <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
        {safeSrc && !hasError ? (
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-[#060F1A]">
